...
struct VertexInput {
  @location(0) position : vec3<f32>, @location(1) tex_pos : vec2<f32>
}
...
@group(1) @binding(0) var<uniform> camera_mat : mat4x4<f32>;
@vertex fn vs_main(model
                   : VertexInput,
                   // entity: EntityInput,
                   )
    ->VertexOutput {
